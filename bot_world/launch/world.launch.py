...
def generate_launch_description():
    ...
    package_directory2=get_package_share_directory("bot_world")

    worlds_path = package_directory2 + "/worlds"
    os.environ['GZ_SIM_RESOURCE_PATH' ] = worlds_path
    ...
    gazebo = IncludeLaunchDescription(
                PythonLaunchDescriptionSource([os.path.join(
                    ...
                    launch_arguments={
                        'pause' : 'True',
                        'gz_args' :'-v 4'+ ' -r ' + package_directory2 + '/world/my_world.sdf',
                    }.items(),
                )
